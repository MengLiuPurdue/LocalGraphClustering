...
def SimpleLocal_weighted_new(G, ref_nodes, levels,
                delta: float = 0.3,gamma: float = 1.0):
    """
    ...
    (actual_length,actual_xids) = SimpleLocal_weighted_new_cpp(n,G.ai,G.aj,G.adjacency_matrix.data,G.d,len(ref_nodes),ref_nodes,delta,gamma,levels)
